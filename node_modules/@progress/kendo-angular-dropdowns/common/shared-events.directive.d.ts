...
export declare class SharedDropDownEventsDirective implements AfterViewInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<SharedDropDownEventsDirective, "[kendoDropDownSharedEvents]", never, { "hostElement": "hostElement"; "clearButtonClicked": "clearButtonClicked"; "isFocused": "isFocused"; }, { "isFocusedChange": "isFocusedChange"; "onFocus": "onFocus"; "handleBlur": "handleBlur"; }, never>;
}
