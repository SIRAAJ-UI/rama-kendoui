...
export declare class PagerComponent implements OnChanges, OnInit, OnDestroy {
    ...
    constructor(pagerContext: PagerContextService, navigationService: NavigationService, element: ElementRef, renderer: Renderer2, zone: NgZone, ctx: ContextService, cellContext: CellContext, focusRoot: FocusRoot, focusGroup: FocusGroup);
    ngOnInit(): void;
    ngDoCheck(): void;
